...
// CareerDevelopment Advanced Data Model
export interface CareerDevelopmentAdvancedRecord {
  id: string;
...
export const CareerDevelopmentAdvancedView: React.FC = () => {
  const [data, setData] = useState<CareerDevelopmentAdvancedRecord[]>([]);
  ...
  const loadData = () => {
    setIsLoading(true);
    setTimeout(() => {
      const raw = localStorage.getItem('advanced_CareerDevelopment_data');
  ...
  const handleSave = () => {
    ...
    const newRecord: CareerDevelopmentAdvancedRecord = {
    ...
    setData(newData);
    localStorage.setItem('advanced_CareerDevelopment_data', JSON.stringify(newData));
    resetForm();
  };
  ...
  const handleEdit = (record: CareerDevelopmentAdvancedRecord) => {

...
// CompensationPlanning Advanced Data Model
export interface CompensationPlanningAdvancedRecord {
  id: string;
...
export const CompensationPlanningAdvancedView: React.FC = () => {
  const [data, setData] = useState<CompensationPlanningAdvancedRecord[]>([]);
  ...
  const loadData = () => {
    setIsLoading(true);
    setTimeout(() => {
      const raw = localStorage.getItem('advanced_CompensationPlanning_data');
  ...
  const handleSave = () => {
    ...
    const newRecord: CompensationPlanningAdvancedRecord = {
    ...
    setData(newData);
    localStorage.setItem('advanced_CompensationPlanning_data', JSON.stringify(newData));
    resetForm();
  };
  ...
  const handleEdit = (record: CompensationPlanningAdvancedRecord) => {

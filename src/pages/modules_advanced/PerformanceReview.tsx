...
// PerformanceReview Advanced Data Model
export interface PerformanceReviewAdvancedRecord {
  id: string;
...
export const PerformanceReviewAdvancedView: React.FC = () => {
  const [data, setData] = useState<PerformanceReviewAdvancedRecord[]>([]);
  ...
  const loadData = () => {
    setIsLoading(true);
    setTimeout(() => {
      const raw = localStorage.getItem('advanced_PerformanceReview_data');
  ...
  const handleSave = () => {
    ...
    const newRecord: PerformanceReviewAdvancedRecord = {
    ...
    setData(newData);
    localStorage.setItem('advanced_PerformanceReview_data', JSON.stringify(newData));
    resetForm();
  };
  ...
  const handleEdit = (record: PerformanceReviewAdvancedRecord) => {

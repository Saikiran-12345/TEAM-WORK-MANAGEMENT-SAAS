...
// ProfitLossStatement Advanced Data Model
export interface ProfitLossStatementAdvancedRecord {
  id: string;
...
export const ProfitLossStatementAdvancedView: React.FC = () => {
  const [data, setData] = useState<ProfitLossStatementAdvancedRecord[]>([]);
  ...
  const loadData = () => {
    setIsLoading(true);
    setTimeout(() => {
      const raw = localStorage.getItem('advanced_ProfitLossStatement_data');
  ...
  const handleSave = () => {
    ...
    const newRecord: ProfitLossStatementAdvancedRecord = {
    ...
    setData(newData);
    localStorage.setItem('advanced_ProfitLossStatement_data', JSON.stringify(newData));
    resetForm();
  };
  ...
  const handleEdit = (record: ProfitLossStatementAdvancedRecord) => {

...
// ObjectiveKeyResults Advanced Data Model
export interface ObjectiveKeyResultsAdvancedRecord {
  id: string;
...
export const ObjectiveKeyResultsAdvancedView: React.FC = () => {
  const [data, setData] = useState<ObjectiveKeyResultsAdvancedRecord[]>([]);
  ...
  const loadData = () => {
    setIsLoading(true);
    setTimeout(() => {
      const raw = localStorage.getItem('advanced_ObjectiveKeyResults_data');
  ...
  const handleSave = () => {
    ...
    const newRecord: ObjectiveKeyResultsAdvancedRecord = {
    ...
    setData(newData);
    localStorage.setItem('advanced_ObjectiveKeyResults_data', JSON.stringify(newData));
    resetForm();
  };
  ...
  const handleEdit = (record: ObjectiveKeyResultsAdvancedRecord) => {

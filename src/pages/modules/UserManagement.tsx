...
export const UserManagementView: React.FC = () => {
  ...
  const loadData = () => {
    ...
    setTimeout(() => {
      const raw = localStorage.getItem('UserManagement_data');
  ...
  const handleSave = () => {
    ...
    setData(newData);
    localStorage.setItem('UserManagement_data', JSON.stringify(newData));
    resetForm();
  };
  ...
  const handleEdit = (record: UserManagementRecord) => {
